...
const SearchTypeVehicule = ({ close }: any) => {
  ...
  return (
    <div className="flex flex-col w-full h-full">
      <div className="flex items-center justify-between pb-3 mb-3 border-b">
        <AText size="base+2">Recherche un type de véhicule</AText>
      ...
      <Form layout="vertical" onFinish={Validate} form={form}>
        <ATInput
          ...
          type="text"
          name={"typeVehicule"}
          label={checked ? "Type du véhicule" : ""}
...
export default SearchTypeVehicule;
