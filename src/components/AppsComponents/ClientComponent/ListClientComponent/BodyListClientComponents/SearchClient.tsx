  ...
  return (
    <div className="flex flex-col w-full h-full">
      <div className="flex items-center justify-between pb-3 mb-3 border-b">
        <AText size="base+2">Recherche un client</AText>
      ...
      <ATInput size="large" type="text" name={"firstName"} label={checked? "Nom": ""} placeholder="Entrez le nom du client" />
        {checked ? (
          <>
            <ATInput size="large" type="text" name={"lastName"} label= "Prénom" placeholder="Entrez le prénom du client" />
